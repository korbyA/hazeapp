  ...
  return (
    ...
    >
      <div className="relative mb-4">
        <div className="w-12 h-12 bg-gradient-primary rounded-lg flex items-center justify-center group-hover:shadow-glow-lg transition-all duration-[3000ms] relative z-10 group-hover:ring-4 group-hover:ring-primary/70 group-hover:drop-shadow-[0_0_28px_hsl(var(--primary)/0.9)]">
          {icon}
        </div>
        <div className="absolute inset-0 w-12 h-12 bg-primary/60 rounded-lg blur-xl opacity-0 group-hover:opacity-100 transition-all duration-[3000ms]" />
        <div className="absolute inset-0 w-12 h-12 bg-primary/80 rounded-lg blur-3xl opacity-0 group-hover:opacity-95 transition-all duration-[3000ms] scale-150" />
        <div className="absolute inset-0 w-12 h-12 bg-primary/70 rounded-lg blur-[40px] opacity-0 group-hover:opacity-90 transition-all duration-[3000ms] scale-[2]" />
      </div>
